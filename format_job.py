professions_english = [
  ...
  { "name": "College Teacher", "keywords": ["College", "Tutor", "Academic", "Education", "Instructor", "Teaching"] },
  ...
  { "name": "Public Relations Officer", "keywords": ["PR", "Communication", "Ambassador", "Media", "Corporate", "Reputation"] },
  { "name": "Lawyer", "keywords": ["Legal", "Law", "Attorney", "Advocate", "Justice", "Associate", "General", "Claims", "Counsel"] },
  { "name": "Archivist and Curator", "keywords": ["Archive", "Document", "Reviewer", "Preservation", "Collection", "History", "Museum"] },
  ...
  { "name": "Social Scientist", "keywords": ["Social", "Research", "Society", "Analysis", "Behavior", "Scientist"] },
  { "name": "Archaeologist", "keywords": ["Archaeology", "History", "Excavation", "Artifacts", "Research", "Archaeologist"] },
  ...
  { "name": "Translator and Interpreter", "keywords": ["Translation", "Interpretation", "Languages", "Communication", "International", "Bilingual"] },
  { "name": "Director: Film/Stage", "keywords": ["Direction", "Film", "Stage", "Production", "Entertainment"] },
  { "name": "Announcer: Radio, Television and Other media", "keywords": ["Broadcasting", "Media", "Presentation", "Communication", "Entertainment", "Air Host"] },
  { "name": "Health Information Administrator", "keywords": ["Health", "PCU", "Credential", "Information", "Administration", "Records", "Healthcare", "Discharge", "Clinical", "Intake", "Coordinator"] },
  { "name": "Museologist", "keywords": ["Museum", "Curator", "Collection", "Exhibition", "Cultural"] },
  { "name": "Secretary", "keywords": ["Administrative", "Office", "Organization", "Support", "Clerical", "Secretary", "Secrétaire"] },
  ...
  { "name": "Tour Guide", "keywords": ["Tourism", "Guide", "Travel", "Information", "Cultural", "Recreation Advisor"] },
  { "name": "Marketing and Sales Assistant", "keywords": ["Marketing", "Merchandiser", "Sales", "Client Advisor", "Business", "Promotion", "Customer", "CSR", "Customer Service Representative", "Account Executive", "Reset Specialist", "Outbound Specialist", "Category Associate"]},
  ...
  { "name": "Chemist", "keywords": ["Chemistry", "Laboratory", "Analysis", "Research", "Science", "Chemist"] },
  { "name": "Geologist", "keywords": ["Geology", "Earth", "Rocks", "Minerals", "Science", "Geologist"] },
  { "name": "Geographer", "keywords": ["Geography", "Land", "Spatial", "Maps", "Environment", "GEOINT"] },
  { "name": "Mathematician", "keywords": ["Mathematics", "Calculation", "Analysis", "Theory", "Logic"] },
  { "name": "Statistician", "keywords": ["Statistics", "Data", "Analysis", "Probability", "Research", "Biostatistician"] },
  ...
  { "name": "Environmental Specialist", "keywords": ["Environment", "Conservation", "Ecology", "Sustainability", "Assessment", "QHSE", "ESG"] },
  { "name": "Industrial Engineer", "keywords": ["Industrial", "Engineering", "Optimization", "Systems", "Efficiency", "Supervisor", "GMP", "Planner", "Estimator", "Assessor", "Engineer"] },
  ...
  { "name": "Materials Engineer", "keywords": ["Materials", "Engineering", "Properties", "Development", "Analysis", "NDT"] },
  ...
  { "name": "Veterinarian", "keywords": ["Veterinary", "Animal", "Medicine", "Healthcare", "Treatment", "Veterinarian"] },
  { "name": "Veterinarian technician", "keywords": ["Veterinary", "Animal", "Technical", "Assistant", "Healthcare", "Veterinarian"] },
  { "name": "Pharmacist", "keywords": ["Pharmacy", "Medicine", "Drugs", "Healthcare", "Dispensing"] },
  { "name": "Accountant", "keywords": ["Accounting", "Bookkeeper", "Finance", "Bookkeeping", "Audit", "Financial", "Accountant", "Deal", "Desk"] },
  { "name": "Financial Analyst", "keywords": ["Financial", "Analysis", "Investment", "Markets", "Business", "Analyst", "BSA"] },
  ...
  { "name": "Computer Scientist: Software Developer", "keywords": ["Computer", "scrum", "Software", "Development", "Programming", "Technology", "Engineer", "Platform", "Developer", "API"] },
  ...
  { "name": "Bank Teller and Related Clerks", "keywords": ["Banking", "Cashier", "Teller", "Financial", "Customer Service", "Transactions", "Banker"] },
  ...
  { "name": "Computer database and network administrators", "keywords": ["Database", "Agile", "Sr", "Trace", "Facets", "Analyst", "BI", "Network", "Administration", "IT", "Systems", "IAM", "Administrator", "Access"] },
  ...
  { "name": "Cosmetologists (Beauticians)", "keywords": ["Cosmetology", "Beauty", "Skincare", "Aesthetics", "Treatment", "Hydrafacial", "Hair", "Stylist"] },
  ...
  { "name": "Cartographers and Surveyors", "keywords": ["Cartography", "Surveyor", "Surveying", "Maps", "Geographical", "Measurement"] },
  ...
  { "name": "Handicraft Workers in Furniture and Home Furnishings Industries", "keywords": ["Handicraft", "Furniture", "Furnishings", "Artisan", "Production", "Upholstery"] },
  ...
  { "name": "Allopathic Medical Doctor", "keywords": ["Medical", "Neuroimmunology", "Cardiologist", "Doctor", "Healthcare", "Physician", "Treatment", "Neonatologist", "Urologist", "Dermatologist", "Surgeon", "Pediatrician"] },
  { "name": "Nurse and Midwife", "keywords": ["Nursing", "Infirmière clinicienne", "Midwifery", "Healthcare", "Patient", "Medical", "nurse", "ICU", "RN", "Staff nurse"] },
  { "name": "Medical Doctor: Traditional Medicine", "keywords": ["Traditional", "Medicine", "Healing", "Alternative", "Healthcare"] },
  { "name": "Dentist", "keywords": ["Dental", "Healthcare", "Oral", "Teeth", "Medical", "General", "Dentist"] },
  { "name": "Occupational Therapist", "keywords": ["Occupational", "Therapy", "Rehabilitation", "Healthcare", "Recovery", "Therapist"] },
  ...
  { "name": "Primary School Teacher", "keywords": ["Primary", "Elementary", "School", "Teaching", "Education", "Children"] },
  { "name": "Special Needs Teacher", "keywords": ["Special", "Needs", "Teaching", "Education", "Disability", "Support", "Teacher"] },
  { "name": "Administration Specialist: Small & Medium Business Management", "keywords": ["Administration", "Deputy", "SME", "Management", "Business", "Operations", "SUPERINTENDENT", "Surintendant"] },
  { "name": "Agribusiness Management", "keywords": ["Agriculture", "Business", "Management", "Farming", "Commercial"] },
  { "name": "Sales and Marketing Manager", "keywords": ["Sales", "Marketing", "Management", "Business", "Strategy", "Area", "Manager", "RSM"] },
  { "name": "Retail and Wholesale Manager", "keywords": ["Retail", "Branch", "Keyholder", "Aventura", "Wholesale", "Management", "Commerce", "Business", "Store", "Leader", "Supply Chain", "Supv", "Shop"] },
  { "name": "Hotel/HORECA Manager", "keywords": ["Hotel", "Hospitality", "Resorts", "Management", "Service", "Tourism", "CATERING"] },
  { "name": "Agriculture Manager", "keywords": ["Agriculture", "Management", "Farming", "Production", "Operations"] },
  { "name": "Hospital Administrator", "keywords": ["Hospital", "Administration", "Healthcare", "Management", "Medical", "Clinic Director"] },
  { "name": "Human Resource Manager", "keywords": ["HR", "Human Resources", "Management", "Personnel", "Recruitment"] },
  { "name": "Administration Specialist: Urban Management", "keywords": ["Urban", "Management", "Administration", "City", "Planning", "Plan", "House"] },
  ...
  { "name": "Psychologist", "keywords": ["Psychology", "Mental Health", "Therapy", "Behavioral", "Assessment", "CBHC", "Psychiatrist", "Consultant"] },
  { "name": "Counsellor", "keywords": ["Counseling", "Support", "Guidance", "Mental Health", "Therapy", "Counselor"] },
  { "name": "Career Counsellor", "keywords": ["Career", "Mentor", "Ghana", "Counseling", "Guidance", "Employment", "Vocational"] },
  { "name": "Medical Technologist: Medical Imaging", "keywords": ["Medical", "Sonographer", "Imaging", "Technology", "Diagnostic", "Radiology", "CT", "Technologist"] },
  { "name": "Medical Technologist: Optometry", "keywords": ["Optometry", "Vision", "Technology", "Eye", "Healthcare"] },
  { "name": "Medical Technologist", "keywords": ["Medical", "Laser", "Technology", "Laboratory", "Healthcare", "Diagnostic", "Clinical Lab Scientist", "MT"] },
  ...
  { "name": "Administration Specialist: Real Estate", "keywords": ["Real Estate", "Estate", "Administration", "Property", "Management", "Commercial", "Asset Manager", "Branch Manager"] },
  { "name": "Social Worker", "keywords": ["Social", "Child Life", "Welfare", "Support", "Community", "Assistance", "Volunteer", "Caregiver"] },
  ...
  { "name": "Food Processing Workers", "keywords": ["Food", "Vendeur", "poissonnerie", "Cake", "Decorator", "Processing", "Production", "Preparation", "Manufacturing"] },
  { "name": "Cook", "keywords": ["Cooking", "Culinary", "Food", "Kitchen", "Preparation", "Chef"] },
  { "name": "Cook Assistant", "keywords": ["Assistant", "Cook", "Kitchen", "Food", "Preparation", "Dish"] },
  { "name": "Waiter", "keywords": ["Waiting", "Service", "Restaurant", "Food", "Hospitality", "Server", "Waiter", "Host" ] },
  { "name": "Receptionist", "keywords": ["Reception", "Front Desk", "Customer Service", "Administrative", "Office", "Host -Chevys"] },
  { "name": "Office clerk", "keywords": ["Clerical", "Office", "Administrative", "Support", "Filing", "supply", "EDTC", "PT Access", "Svcs"] },
  ...
  { "name": "Police Officer", "keywords": ["Police", "Law Enforcement", "Surveillance", "Investigator", "Sheriff", "Security", "Criminal Justice", "Public Safety"] },
  ...
  { "name": "Electrical Engineering Technician (Turbines)", "keywords": ["Electrical", "Turbine", "Technical", "Engineering", "Energy", "Wind", "technician"] },
  ...
  { "name": "Transport Technician", "keywords": ["Transport", "Logistical", "Technical", "Maintenance", "Vehicles", "Logistics"] },
  ...
  { "name": "Environmental Protection Technician", "keywords": ["Environmental", "Protection", "Technical", "Conservation", "Monitoring", "Inspector", "QC"] },
  ...
  { "name": "Pilot", "keywords": ["Aviation", "Flying", "Aircraft", "Navigation", "Transportation", "Pilot"] },
  ...
  { "name": "Laboratory Technician", "keywords": ["Laboratory", "Technical", "Analysis", "Testing", "Research", "Lab", "Tech"] },
  ...
  { "name": "Sports Professional", "keywords": ["Sports", "Lifeguard", "Coach", "Athletic", "Professional", "Physical", "Competition", "Pickleball"] },
  ...
  { "name": "Plumber and Pipe Fitter", "keywords": ["Plumbing", "Pipefitting", "Installation", "Maintenance", "Construction", "Pipe", "Plum"] },
  { "name": "Tool and Die Maker", "keywords": ["Tool", "Die", "Manufacturing", "Precision", "Metalwork", "Fixture", "Builder"] },
  ...
  { "name": "Mechanical Technician (Metal Working)", "keywords": ["Mechanical", "Machinist", "Milling", "Metalworking", "Technical", "Fabrication", "Manufacturing"] },
  ...
  { "name": "Building Finisher", "keywords": ["Building", "Finishing", "Construction", "Interior", "Craftsmanship", "Foreman", "Roofing", "Maintenance", "Mantenimiento"] },
  ...
  { "name": "Assembler", "keywords": ["Assembly", "Manufacturing", "Production", "Components", "Factory", "Assembler"] }
]

professions_vietnamese = [
  ...
  {"name": "Journalist", "keywords": ["Nhà báo", "Tin tức", "Phóng viên", "Truyền thông", "Thời sự", "CỘng tác viên", "Viết bài", "CTV"]},
  ...
  {"name": "Marketing and Sales Assistant", "keywords": ["Trợ lý tiếp thị", "Trợ lý bán hàng", "Marketing", "Kinh doanh", "Khách hàng", "MARKET RESEARCHER", "Content SEO", "Cộng tác viên", "sale", "E-Commerce", "MONETIZATION SPECIALIST"]},
  ...
  { "name": "Industrial Engineer", "keywords": ["Kỹ sư công nghiệp", "Tối ưu hóa", "Hệ thống", "Hiệu quả", "Sản xuất", "QA/QC"] },
  ...
  { "name": "Mechanical Engineer", "keywords": ["Kỹ sư cơ khí", "Máy móc", "Thiết kế", "Hệ thống", "Cơ khí", "thiet ke", "cơ"] },
  ...
  { "name": "Financial Analyst", "keywords": ["Chuyên viên phân tích tài chính", "Đầu tư", "Thị trường", "Tài chính", "Kinh doanh", "RELATIONSHIP MANAGER"]},
  ...
  { "name": "Computer Scientist: Software Developer", "keywords": ["Lập trình viên", "Brse", "Phần mềm", "Công nghệ", "Lập trình", "FULLSTACK DEVELOPER", "TESTER ", "IT", "BACK-END", "SOFTWARE DEVELOPER", "FRONTEND DEVELOPER", "IOS DEVELOPER", "JAVA DEVELOPER", "ANDROID DEVELOPER"]},
  ...
  {"name": "Graphic and Multi Media Designer", "keywords": ["Nhà thiết kế đồ họa", "Thiết kế", "Đa phương tiện", "Hình ảnh", "Sáng tạo", "GRAPHIC DESIGNER"]},
  ...
  {"name": "Treasurer", "keywords": ["Thủ quỹ", "Tài chính", "Quản lý", "Ngân sách", "Quỹ", "Thu ngân"]},
  ...
  {"name": "Handicraft Workers in Textile-Garment and Leather-Footwear Industries", "keywords": ["Thợ thủ công dệt may", "Da giày", "Thủ công", "Dệt may", "Sản xuất", "THỢ MAY"]},
  ...
  {"name": "Sales and Marketing Manager", "keywords": ["Giám đốc kinh doanh tiếp thị", "Marketing", "Bán hàng", "Chiến lược", "Quản lý", "MERCHANDISER", "key Account", ""]},
  {"name": "Retail and Wholesale Manager", "keywords": ["Quản lý bán lẻ bán sỉ", "Bán lẻ", "Bán sỉ", "Thương mại", "Quản lý", "THU MUA"]},
  ...
  {"name": "Human Resource Manager", "keywords": ["Giám đốc nhân sự", "Nhân sự", "Tuyển dụng", "Quản lý", "Nhân viên", "HR"]},
  ...
  {"name": "Food Processing Workers", "keywords": ["Công nhân chế biến thực phẩm", "Thực phẩm", "Chế biến", "Sản xuất", "Nhà máy", "THỨC ĂN NHANH"]},
  {"name": "Cook", "keywords": ["Đầu bếp", "Nấu ăn", "Ẩm thực", "Nhà hàng", "Chế biến", "Bếp trưởng"]},
  ...
  {"name": "Office clerk", "keywords": ["Nhân viên văn phòng", "Hành chính", "Văn thư", "Văn phòng", "Giấy tờ", "Phụ kho"]},
...
def _create_merged_professions():
    ...
    # Tạo dictionary để map profession name với Vietnamese keywords
    vietnamese_dict = {prof["name"]: prof["keywords"] for prof in professions_vietnamese}
    
    for english_prof in professions_english:
        ...
        merged_profession = {
            ...
            "vietnamese_keywords": vietnamese_keywords,
            "all_keywords": english_prof["keywords"] + vietnamese_keywords
        }
        
        merged_professions.append(merged_profession)
...
def normalize_title(title):
    """
    Normalize job title sử dụng mảng merged professions
    """
    result = normalize_title_enhanced(title, "both", 0.8)
    return result["profession"]

def normalize_title_enhanced(title, language="both", threshold=0.8):
    """
    Phiên bản nâng cao của normalize_title với nhiều tùy chọn hơn
    
    Args:
        title (str): Job title cần normalize
        language (str): "english", "vietnamese", hoặc "both"
        threshold (float): Ngưỡng score để match (0.0-1.0)
    
    Returns:
        dict: Thông tin chi tiết về match
    """
    import re
    if not title:
        return {"profession": "Unknown", "score": 0.0, "matched_keyword": None}
    
    normalized = re.sub(r'\([^)]*\)', '', title)
    normalized = re.sub(r'-.*$', '', normalized) 
    normalized = re.sub(r'[^a-zA-Zàáạảãâầấậẩẫăằắặẳẵèéẹẻẽêềếệểễìíịỉĩòóọỏõôồốộổỗơờớợởỡùúụủũưừứựửữỳýỵỷỹđ\s]', '', normalized)
    ...
    # Sử dụng mảng merged tĩnh thay vì tạo mới mỗi lần
    for profession in MERGED_PROFESSIONS:
        # Chọn keywords theo ngôn ngữ
        keywords_to_check = []
        if language == "english":
            keywords_to_check = profession["english_keywords"]
        elif language == "vietnamese":
            keywords_to_check = profession["vietnamese_keywords"]
        else:  # both
            keywords_to_check = profession["all_keywords"]
        
        for keyword in keywords_to_check:
            # Bỏ qua keywords quá ngắn (1-2 ký tự) để tránh false positive
            ...
            # Method 2: Token-based matching với cải tiến
            keyword_tokens = keyword_normalized.split()
            if not keyword_tokens:
                continue
                
            # Chỉ tính score nếu có ít nhất 2 tokens hoặc 1 token dài >= 4 ký tự
            if len(keyword_tokens) == 1 and len(keyword_tokens[0]) < 4:
                continue
                ...
                if token in normalized_tokens:
                    ...
                    for norm_token in normalized_tokens:
                        if token in norm_token or norm_token in token:
                            match_count += 0.7  # Partial match score
                            break
